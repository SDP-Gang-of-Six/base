...
public class VaccineEsTest {
    ...
    @Test
    public void creatVaccineIndex(){
        Class<Vaccine> aClass = Vaccine.class;
    ...
    @Test
    public void deleteVaccineIndex(){
        Class<Vaccine> aClass = Vaccine.class;
    ...
    @Test
    public void rebuildVaccineIndex(){
        Class<Vaccine> aClass = Vaccine.class;
        boolean deleted = elasticsearchRestTemplate.indexOps(aClass).delete();
        boolean created = elasticsearchRestTemplate.indexOps(aClass).createWithMapping();
        if(deleted&&created){
    ...
    public void findAllVaccine(){
        vaccineEsRepo.findAll().forEach(vaccine -> { log.info(String.valueOf(vaccine));});
    }

    @Test
    public void deleteAllVaccine(){
        vaccineEsRepo.deleteAll();
    }
}
